...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section} md:pt-0 pt-14 800px:my-4 p-4 text-white rounded overflow-hidden shadow`}>
      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-900 pb-4">
          <button
            ...
            onClick={() => toggleTab(2)}
          >
            <span className="text-lg text-start font-bold text-white">
